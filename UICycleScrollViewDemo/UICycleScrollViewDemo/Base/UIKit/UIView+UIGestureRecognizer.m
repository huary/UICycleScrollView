...
static char UIViewAllGestureTargetsKey;

//IMPLEMENTATION_FOR_CLASS(YZHIntervalGestureRecognizerActionOptionsInfo)
...
{
    NSMutableArray *targets = objc_getAssociatedObject(self, &UIViewAllGestureTargetsKey);
    if (targets == nil) {
        targets = [NSMutableArray array];
        objc_setAssociatedObject(self, &UIViewAllGestureTargetsKey, targets, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return targets;
}
...
//{
//    NSLog(@"self=%p,targets=%@",self,self.gestureTargets);
//}
